...
Entonces se optó por pasar a una filosofía pura de DevOps, donde los mismos desarrolladores darían soporte a la aplicación en producción y a la vez se incorporaron tecnologías y prácticas para poder implementar \gls{ci-cd}.
