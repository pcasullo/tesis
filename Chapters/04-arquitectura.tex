...
El nuevo proceso resultante, elimina todos los elementos de complejidad accidental, dejando simplemente a los únicos dos roles, que son relevantes, el \emph{End User} que es el usuario final quien solicita el acceso al reporte y el \emph{Aprobador o Dueño del reporte}, que es quien determina si la solicitud corresponde o no y puede actuar en consecuencia.

EL proceso resultante de la simplificación e integración del portal conlas herramientas de visualización y también del RLS (en caso de ser necesario), se describe en la \emph{Fig.} \ref{fig:procesoMejorado}.
